    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioSeguidor", x => new { x.SeguidorId, x.SeguindoId });
                    table.ForeignKey(
                        name: "FK_UsuarioSeguidor_Usuarios_SeguidorId",
                        column: x => x.SeguidorId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsuarioSeguidor_Usuarios_SeguindoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuarioSeguidor_SeguindoId",
